void setup()
{
  ...
  gameObjects.add(new Player(150, 150, 0, color(0, 255, 0), 40));
  gameObjects.add(new Player(350, 350, 0, color(0, 255, 0), 40));
  gameObjects.add(new Player(350, 150, 0, color(0, 255, 0), 40));
}
